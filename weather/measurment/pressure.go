...
func init() {
	...
	PressureHPA = value.NewLowerBoundUnit("PressureHPA", "Pressure", "Pressure Hecto Pascals", " hPa", 1, 0)
	PressureKPA = value.NewLowerBoundUnit("PressureKPA", "Pressure", "Pressure Kilo Pascals", " kPa", 1, 0)
	...
	value.NewTransformations(PressurePA, PressureHPA, PressureKPA, PressurePSI, PressureInHg, PressureMmHg, PressureBar, PressureCBar, PressureMBar)
}
