...
func init() {
	PartsPerMillion = value.NewLowerBoundUnit("PartsPerMillion", "Concentration", "Parts per million", " ppm", value.Dp3, 0)
	MicrogramsPerCubicMeter = value.NewLowerBoundUnit("MicrogramsPerCubicMeter", "Concentration", "Micrograms Per Cubic Meter", " µg/m³", value.Dp3, 0)
