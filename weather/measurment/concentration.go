...
func init() {
	PartsPerMillion = value.NewLowerBoundUnit("PartsPerMillion", "Concentration", "Parts per million", " ppm", 0, 0)
	MicrogramsPerCubicMeter = value.NewLowerBoundUnit("MicrogramsPerCubicMeter", "Concentration", "Micrograms Per Cubic Meter", " µg/m³", 0, 0)
