...
type Builder[T any] interface {
	...
	CalculateFrom(func(Visitor[T], *CalculateFrom) error) Builder[T]
	Command(func(Visitor[T], command.Command) error) Builder[T]
	...
	ExpressionAtom(func(Visitor[T], *ExpressionAtom) error) Builder[T]
	ExpressionLevel1(func(Visitor[T], *ExpressionLevel1) error) Builder[T]
	ExpressionLevel2(func(Visitor[T], *ExpressionLevel2) error) Builder[T]
	ExpressionLevel3(func(Visitor[T], *ExpressionLevel3) error) Builder[T]
	ExpressionLevel4(func(Visitor[T], *ExpressionLevel4) error) Builder[T]
	ExpressionLevel5(func(Visitor[T], *ExpressionLevel5) error) Builder[T]
