...
\ParameterDescription{
    ...
    \item[latitude] latitude\index{Latitude} of the station
    \item[longitude] longitude\index{Longitude} of the station
    \item[altitude] altitude\index{Altitude}\sidenote{
