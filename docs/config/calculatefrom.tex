...
\begin{table}[ht]
    ...
    \begin{tabular}{l l}
        ...
        Aggregator & Function \\
        \midrule
        avg & Average   \index{avg}\index{Aggregate!avg}\index{Function!avg}\\
        min & Minimum   \index{min}\index{Aggregate!min}\index{Function!min}\\
        max & Maximum   \index{max}\index{Aggregate!max}\index{Function!max}\\
        sum & Summation \index{sum}\index{Aggregate!sum}\index{Function!sum}\\
        \bottomrule
    \end{tabular}
\end{table}
