...
\begin{eqnarray}
        d &=& \begin{cases}
            \dfrac{ 17.368\,\AmbientTemperature }{ 238.88 + \AmbientTemperature } & \quad \textbf{if } \AmbientTemperature > 0\\
            \\
            \dfrac{ 17.996\,\AmbientTemperature }{ 247.15 + \AmbientTemperature } & \quad \textbf{if } \AmbientTemperature \leq 0
        \end{cases} \\
