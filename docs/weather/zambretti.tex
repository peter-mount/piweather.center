\subsection{Zambretti Forecaster}
...
as the primary input. The season (Summer or Winter) and the wind play a minor role in determining the
forecast.

\subsubsection{Implementation}

The Zambretti Forecast is implemented with the
\Command{CalculateZambrettiForecast}\index{CalculateZambrettiForecast}
function.
